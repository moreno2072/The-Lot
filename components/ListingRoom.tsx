  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-8">
      {checkoutStatus === 'success' && (
        <div className="mb-6 rounded border border-green-600/30 bg-green-50 px-4 py-3 text-sm text-green-800">
          Payment successful — thank you for your purchase! The seller will be in touch about shipping.
        </div>
      )}
      {checkoutStatus === 'cancelled' && (
        <div className="mb-6 rounded border border-hammer/30 bg-red-50 px-4 py-3 text-sm text-hammer">
          Checkout was cancelled. You can try again anytime before the listing closes.
        </div>
      )}
